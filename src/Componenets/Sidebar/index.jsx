  ...
  return (
    ...
    context.isSidebarOpen ? "w-[18%]" : "w-[0%]"
        ...
        <ul className="mt-4">
            ...
            <Collapse isOpened={subMenuIdx.includes(4) ? true : false}>
              <ul className="w-full">
                <li className="w-full">
                 ...
                 <li className="w-full">
                  <Button className="!w-full gap-2 !text-[rgba(0,0,0,0.7)] !capitalize !justify-start !text-[13px] !font-[500] !pl-9" onClick={()=>{context.setisOpenFullScreenPanel({open:"true",model:"Add adsBanner"})}}>
                                        {/* Dot */}
                    <span className="block w-[5px] h-[5px] rounded-full bg-[rgba(0,0,0,0.2)]"></span>
          ...
          {/* logout */}
          <li>
            <Button type='submit' className="w-full !capitalize !justify-start flex hover:!bg[#f1f1f1] !py-2 gap-3 text-[14px] !text-[rgba(0,0,0,0.7)] !font-[500] items-center"
             onClick={() => { 
                handleClose(); 
                logout(); 
              }} >
